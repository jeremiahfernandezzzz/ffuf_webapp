...
abstract class AbstractDeserializer implements DeserializerInterface{
    ...
    protected function doDeserialize(array $data, $targetClass){
        ...
        if ($this->dispatcher->hasClassListener(EventDispatcherInterface::EVENT_DESERIALIZE, $class)) {
            $instance = $this->dispatcher->dispatchClass(EventDispatcherInterface::EVENT_DESERIALIZE, $instance);
        }
        return $instance;
    }
